...
The test suite runs 410 checks on Linux and Windows. The checks replace iCloud with a stub, so they
...
python tests/test_regressions.py    # bugs found in real use (70 checks)
```
